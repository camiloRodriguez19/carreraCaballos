        ...
        while (true) {
            ...
            if (esti.getLocation().x >= vista.getMeta().getLocation().x - 10) {
                if (c1 > c2 && c1 > c3 && c1 > c4) {
                   vista.txtmostrar.setText("El ganador es: " + "Sultán");
                   
                } else if (c2 > c1 && c2 > c3 && c2 > c4) {
                   vista.txtmostrar.setText("El ganador es: " + "Impetuoso");

                } else if (c3 > c1 && c3 > c3 && c3 > c4) {
                   vista.txtmostrar.setText("El ganador es: " + "Kentucky");

                } else if (c4 > c1 && c4 > c2 && c4 > c3) {
                   vista.txtmostrar.setText("El ganador es: " + "Galan");
                } else {
